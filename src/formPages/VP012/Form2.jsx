...
function VP012Page() {
  ...
  return (
    <div className="vp012_2">
      ...
      <input className="driverLic2" type="text" value={driverLicense2} onChange={(event)=>{setDriverLicense2(event.target.value)}}/>
      ...
      <label className="custom-checkbox custom-checkbox0122">
        <input type="checkbox"/><span></span>
      </label>

      <label className="custom-checkbox custom-checkbox0123">
        <input type="checkbox"/><span></span>
      </label>
