function SP66Page3() {
    ...
    <div className="sp66_3">
      ...
      <label className="custom-checkbox custom-checkbox66_3_0">
        <input type="checkbox"/><span></span>
      </label>

      <label className="custom-checkbox custom-checkbox66_3_1">
        <input type="checkbox"/><span></span>
      </label>

      <label className="custom-checkbox custom-checkbox66_3_2">
        <input type="checkbox"/><span></span>
      </label>
