...
function VihicleInfo() {
    ...
    const {vehicleID, setVehicleID, year, setYear, make, setMake, model, setModel, weight, setWeight, fuel, setFuel, body, setBody, odometer, setOdometer} = useContext(Context);
...
return (
    <>
      ...
      {typeof vehicleID === "object" ? 
        ...
        <div className="vehicleInformation">
          <p>Odometer</p><input className="odometer" maxLength='6' type="text" value={odometer.join('')} onChange={(event)=>{setOdometer(event.target.value)}}/>
        </div> 
        : 
        <div className="vehicleInformation">
          <p>Odometer</p><input className="odometer" maxLength='6' type="text" value={odometer} onChange={(event)=>{setOdometer(event.target.value)}}/>
        </div>}
